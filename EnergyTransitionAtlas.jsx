      ...
      <div className="hidden md:block bg-[#424244] px-6 py-3">
        <div className="max-w-7xl mx-auto flex items-center gap-5 overflow-x-auto scrollbar-hide">
          ...
          {(brandBarConfig?.owners || [
            ...
            { name: "GINGR", url: BRAND_LINKS.GINGR, logo: "logos/gingr.svg" },
            { name: "IUCN", url: BRAND_LINKS.IUCN, logo: "logos/iucn.png" },
          ]).map(b => {
            // Optical sizing: IUCN has more internal padding than RGI/GINGR, so it needs ~30% extra height (matches footer 52:68 ratio)
            const heightClass = b.name === "IUCN" ? "h-[32px]" : "h-[24px]";
