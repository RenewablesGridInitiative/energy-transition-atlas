            ...
            <div className="space-y-6 text-[#424244] leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-4 mt-4">
                {[
                  ...
                  { name: "GINGR", url: BRAND_LINKS.GINGR, desc: "The Global Initiative for Nature, Grids and Renewables extends the mission of nature-positive energy infrastructure beyond Europe to a global scale." },
                ].map((partner) => (
                  <a
                    key={partner.name}
                    href={partner.url}
