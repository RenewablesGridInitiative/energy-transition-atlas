...
function HeroGraphic() {
  return (
    <div className="relative w-full max-w-[380px] mx-auto" style={{ aspectRatio: "428.6/395.04" }}>
      <style>{`
      ...
      `}</style>
      <svg viewBox="0 0 428.6 395.04" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" aria-hidden="true">
        ...
        <g className="hero-cloud-2 hero-enter" style={{ animationDelay: "1.6s" }} opacity="0.22" transform="translate(-10,-130)">
        ...
        {/* ── Globe — grid lines ── */}
        <g className="hero-enter" style={{ animationDelay: "0.15s" }} opacity="0.35">
        ...
        <g className="hero-enter" style={{ animationDelay: "0.1s" }} opacity="0.55">
        ...
        {/* ── Place markers (on globe) ── */}
        <g className="hero-el hero-enter" style={{ animationDelay: "0.25s" }} opacity="0.85">
        ...
        {/* ── Figures talking (bottom-left) ── */}
        <g className="hero-el hero-enter" style={{ animationDelay: "1.0s" }} opacity="0.75">
      ...
      <div className="hidden md:block bg-[#424244] px-6 py-3">
        <div className="max-w-7xl mx-auto flex items-center gap-5 overflow-x-auto scrollbar-hide">
          ...
          {(brandBarConfig?.owners || [
            { name: "RGI", url: BRAND_LINKS.RGI, logo: "logos/rgi-white.svg" },
            { name: "GINGR", url: BRAND_LINKS.GINGR, logo: "logos/gingr-white.svg" },
            ...
            const heightClass = b.name === "IUCN" ? "h-[32px]" : b.name === "GINGR" ? "h-[30px]" : "h-[24px]";
            const logoVer = brandBarConfig?.logoVersion || 1;
            const needsFilter = b.logo?.endsWith('.png');
            return b.logo ? (
