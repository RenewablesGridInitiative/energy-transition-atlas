          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-xl border border-[#C9C9C9] p-8">
              ...
              <a
                ...
                className="flex max-w-full items-center gap-2 sm:gap-3 px-5 sm:px-8 py-3 sm:py-3.5 rounded-3xl sm:rounded-full bg-[#6B21A8] text-white font-medium hover:bg-[#6B21A8]/90 transition-colors text-sm sm:text-lg"
              >
