...
function HeroGraphic() {
  return (
    <div className="relative w-full max-w-[440px] mx-auto" style={{ aspectRatio: "500/440" }}>
      <style>{`
        ...
        @media (prefers-reduced-motion: no-preference) {
          ...
          .hero-continents { animation: hero-continent-reveal 1.2s ease-out 0.3s both; }
        }
        .hero-el { transition: filter 0.3s ease, transform 0.3s ease; }
        .hero-el:hover { filter: drop-shadow(0 0 8px rgba(255,248,229,0.5)); }
      `}</style>
      <svg viewBox="60 80 370 340" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" aria-hidden="true">
      ...
      <div className="hidden md:block bg-[#424244] px-6 py-3">
        <div className="max-w-7xl mx-auto flex items-center gap-5 overflow-x-auto scrollbar-hide">
          ...
          {(brandBarConfig?.owners || [
            ...
            { name: "GINGR", url: BRAND_LINKS.GINGR, logo: "gingr-logo-grey.svg" },
