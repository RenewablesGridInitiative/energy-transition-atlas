...
const PRACTICES = [
  ...
  { id: 317, title: "Communication materials to address concerns on EMF", url: "https://renewables-grid.eu/database/communication-materials/", brand: "RGI", dim: "People", topic: "Creating Awareness & Capacity Building", inf: "Grids", year: 2010, country: "", org: "RTE – Réseau de Transport d’Electricité", desc: "To respond to the concerns of citizens about the potential negative health impacts of EMF, RTE undertook several educational measures. Main Information First of all, a website has been established. Under the name “la clef des champs” (the key to the fields), RTE produces information for different interests. With the help of video clips, illustrations […]", img: "https://renewables-grid.eu/app/uploads/2026/03/2010_Database_RTE_CommunicationMaterials1-644x398-c-default.png", award: false },
